...
const Contact = () => {
    return (
        <>
            ...
            <section className="min-h-screen bg-white dark:bg-gray-900 lg:flex mb-40">
                <div className="flex w-full flex-col justify-center p-8 lg:w-1/2 lg:bg-gray-100 lg:px-12 lg:dark:bg-gray-800 xl:px-32">
                    ...
                    <div className="mt-6 md:mt-8">
                        ...
                        <div className="-mx-1.5 mt-4 flex">
                            <a className="mx-1.5 transform text-gray-400 transition-colors duration-300 hover:text-blue-500 dark:hover:text-blue-400" href="#">
